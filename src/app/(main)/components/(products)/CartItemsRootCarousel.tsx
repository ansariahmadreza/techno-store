...
const CartItemRootCarousel = ({ info, qty }: IcartItemsProps) => {
    return (
        <Suspense >
            <Container>
                <section
                    className="w-[90%]  max-w-225 mx-auto mt-10 p-6 
        flex flex-col sm:flex-row items-center justify-between  gap-6 border-2 border-neutral-200 rounded-xl shadow-lg  bg-white overflow-hidden">
